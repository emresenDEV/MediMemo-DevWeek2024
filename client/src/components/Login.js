...
function Login({ type, setUsers }) {
  ...
  function handleFocus(e) {
    // lets user click on any part of the div to type their information
  ...
  const [formData, setFormData] = useState(
    // temporarily stores what the user has entered into the form
    { email: "", password: "", provider_code: "" },
  );

  function handleChange(e) {
    // adds any changes to the form to the temporary storage
    setFormData({
      ...formData,
      ...
      <div className="overlay">
        <div className="overlay-col col-left">
          <div className="login-text">
            ...
            <div className={`user-type`}>
              <a
                className={type === "provider" ? "active" : "inactive"}
                href="/provider-login"
              >
                Provider
              </a>
              <a
                className={type === "client" ? "active" : "inactive"}
                href="/client-login"
              >
                Patient
              </a>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p id="password-rules">
                Password must be 8 characters with a capital letter, a number,
                and a symbol
              </p>
              {type === "client" ? (
                <div className="input-div" onClick={handleFocus}>
              ...
              <div className="remember-forgot">
                ...
                <span id="span-forgot">
                  <a id="forgot-password" href="/recover-password">
                    Forgot password?
                  </a>
                </span>
              </div>
              <div>
                <button id="login-button" type="submit" name="login">
                  Log In
                </button>
                {/* <button id="login-button" type="submit" onClick={handleLogin}>Login</button> */}
                <button id="signup-button" type="submit" name="signup">
                  Create Account
                </button>
              </div>
            </form>
        ...
        <div className="overlay-col col-right">
          <img
            ...
            alt="place holder"
            src="assets/female-doctor-and-patient.webp"
          />
        </div>
      </div>
    </div>
