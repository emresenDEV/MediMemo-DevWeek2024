...
def write_to_join_csv(insurances_patients_join):
    with open('insurances_patients_join.csv', 'w', newline='') as csvfile:
        ...
        writer.writerow(["insurance_id", "patient_id", 'primary_insured_name', 'primary_insured_birthdate',
                        'primary_insured_SSN', 'primary_insured_relationship', 'member_number', 'group_number'])
